...
public enum MobBestiary {
    ...
    static {
        ...
        REGIONAL.addEntities(Rat.class, Snake.class, Gnoll.class, Swarm.class, Crab.class, Slime.class,
                GiantWorm.class, Mayfly.class, Dog.class, Goblin.class,

                Skeleton.class, Thief.class, DM100.class, Guard.class, Necromancer.class,
                Jailer.class, Prisoner.class,  Torturer.class, Grudge.class,

                Bat.class, Brute.class, Shaman.RedShaman.class, Shaman.BlueShaman.class, Shaman.PurpleShaman.class, Spinner.class, DM200.class, GnollZealot.class, DM175.class,
                Drake.class, StoneSpirit.class,
                ...
                Artillerist.class, ShieldMage.class,
                ClusteredSkeleton.class, RoyalGuard.class,
        ...
        ALLY.addEntities(MirrorImage.class, PrismaticImage.class,
                ...
                //WandOfWarding.Ward.WardSentry.class,
